...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PizzaShopApi.PromoApi();
  });
  ...
  describe('PromoApi', function() {
    ...
    describe('offers', function() {
      it('should call offers successfully', function(done) {
        //uncomment below and update the code to test offers
        //instance.offers(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
