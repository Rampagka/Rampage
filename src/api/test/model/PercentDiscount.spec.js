...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PizzaShopApi.PercentDiscount();
  });
  ...
  describe('PercentDiscount', function() {
    it('should create an instance of PercentDiscount', function() {
      // uncomment below and update the code to test PercentDiscount
      //var instance = new PizzaShopApi.PercentDiscount();
      //expect(instance).to.be.a(PizzaShopApi.PercentDiscount);
    });
