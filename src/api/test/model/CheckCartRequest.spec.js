...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PizzaShopApi.CheckCartRequest();
  });
  ...
  describe('CheckCartRequest', function() {
    it('should create an instance of CheckCartRequest', function() {
      // uncomment below and update the code to test CheckCartRequest
      //var instance = new PizzaShopApi.CheckCartRequest();
      //expect(instance).to.be.a(PizzaShopApi.CheckCartRequest);
    });
